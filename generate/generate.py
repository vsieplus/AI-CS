...
def get_filter_indices(chart_type):
    ...
    # filter 1: The only possible next arrow states for a current hold is another hold 'H' (3) or release 'W' (4)
    # filter 2: A hold note 'H' must follow a hold start 'M' (2) or another hold 'H' (3)
    # filter 3: A release note 'W' must follow a step 'M' (2) or another hold 'H' (3)
